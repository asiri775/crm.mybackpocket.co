...
return [
    ...
    [
        'key' => 'projects.edit',
        'name' => 'admin::app.acl.edit',
        'route' => ['admin.projects.edit', 'admin.projects.update'],
        'sort' => 2,
    ],
    [
        'key' => 'projects.delete',
    ...
    [
        'key' => 'projects.tasks.create',
        'name' => 'admin::app.acl.create',
        'route' => ['admin.projects.tasks.create', 'admin.projects.tasks.store'],
        'sort' => 1,
    ],
    [
        'key' => 'projects.tasks.edit',
        'name' => 'admin::app.acl.edit',
        'route' => ['admin.projects.tasks.edit', 'admin.projects.tasks.update'],
        'sort' => 2,
    ],
    [
        'key' => 'projects.tasks.delete',
        'name' => 'admin::app.acl.delete',
        'route' => ['admin.projects.tasks.delete', 'admin.projects.tasks.mass_delete'],
        'sort' => 3,
    ],
    [
        'key' => 'projects.tasks.view',
        'name' => 'admin::app.acl.view',
        'route' => 'admin.projects.tasks.view',
        'sort' => 3,
    ],
    ...
    [
        'key' => 'projects.categories.create',
        'name' => 'admin::app.acl.create',
        'route' => ['admin.projects.categories.create', 'admin.projects.categories.store'],
        'sort' => 1,
    ],
    [
        'key' => 'projects.categories.edit',
        'name' => 'admin::app.acl.edit',
        'route' => ['admin.projects.categories.edit', 'admin.projects.categories.update'],
        'sort' => 2,
    ],
    [
        'key' => 'projects.categories.delete',
        'name' => 'admin::app.acl.delete',
        'route' => ['admin.projects.categories.delete', 'admin.projects.categories.mass_delete'],
        'sort' => 3,
    ],
    [
        'key' => 'projects.categories.view',
        'name' => 'admin::app.acl.view',
        'route' => 'admin.projects.categories.view',
        'sort' => 3,
    ],
