...
<div class="flex">
    ...
    <v-mail-activity ref="mailActionComponent" :entity="{{ json_encode($entity) }}"
        entity-control-name="{{ $entityControlName }}"></v-mail-activity>
</div>
        ...
        app.component('v-mail-activity', {
            ...
            methods: {
                ...
                save(params, {
                    ...
                    this.$axios.post("{{ route('admin.leads.emails.store', 'replaceLeadId') }}".replace(
                            'replaceLeadId', this.entity.id), formData, {
                            headers: {
