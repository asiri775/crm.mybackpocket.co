...
@pushOnce('scripts')
    ...
    >
        <div class="w-full">
            <div class="table-responsive datagrid-table box-shadow rounded-t-0 grid w-full overflow-hidden border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                <slot
                    name="header"
                    :is-loading="isLoading"
                    :available="available"
                ...
                >
                    ...
                    <template v-else>
                        ...
                        >
                            <!-- Mass Actions -->
                            <p v-if="available.massActions.length" class="checkbox-field-table">
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <template v-else>
                            <div class="table-bottom row grid border-b px-4 py-4 text-center text-gray-600 dark:border-gray-800 dark:text-gray-300">
                                <p>
