    ...
    >
        ...
        >
            ...
            <template v-else>
                ...
                >
                    <x-slot:toggle>
                        <div class="relative flex cursor-pointer items-center btn-style rounded-md bg-sky-100 px-4 py-[9px] font-semibold text-sky-600 dark:bg-brandColor dark:text-white">
