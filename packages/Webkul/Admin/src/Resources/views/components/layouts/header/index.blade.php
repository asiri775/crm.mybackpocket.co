<header
    class="sticky top-0 z-[10001] flex items-center justify-between bg-black px-4 py-2 transition-all dark:border-gray-800 dark:bg-gray-900">
    <!-- logo -->
    <div class="flex items-center gap-1.5">
        <a href="javascript:;" class="open-main-menu">
    ...
    <div class="flex items-center gap-2.5 header-right-side">
        <!-- Dark mode -->
        {{-- <v-dark>
            <div class="flex">
                <span
        ...
        <x-admin::dropdown position="bottom-right">
            <x-slot:toggle>
                <button
                    class="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full user-dropdown-img-bx font-semibold leading-6 text-white">
            ...
            <x-slot:content class="!p-0">
                ...
                <div class="grid gap-1 user-dropdownmenu">
