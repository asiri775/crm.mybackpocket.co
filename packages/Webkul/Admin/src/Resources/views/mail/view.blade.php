...
@section('mailLayoutBody')
    ...
    <div class="mail-layout-with-sidebar">
        @include('admin::mail.layout.sidebar')
        <div class="mail-layout-with-sidebar-right">
            <v-email-list>
    ...
    @pushOnce('scripts')
        ...
        >  
            <div class="flex gap-0 max-xl:flex-wrap">
                ...
                @if (
                    ...
                    <div class="sticky top-4 flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                        <div class="box-shadow bg-white dark:bg-gray-900">
        ...
        >
            <div class="box-shadow flex gap-2.5 mail-view-content-box bg-white p-4 dark:bg-gray-900 max-xl:flex-wrap">
        ...
        >
            <div class="flex w-full gap-2">
                ...
                <div class="w-full gap-2 rounded border p-4">
                    <x-admin::form
