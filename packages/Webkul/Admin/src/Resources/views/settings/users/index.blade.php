                ...
                <template #body="{
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <!-- Users user_status -->
                            <span
                                :class="record.user_status == 1 ? 'label-active' : 'label-inactive'"
                            >
                                @{{ record.user_status == 1 ? '@lang('admin::app.settings.users.index.active')' : '@lang('admin::app.settings.users.index.inactive')' }}
                            </span>
                ...
                >
                    ...
                    <x-admin::modal ref="userUpdateAndCreateModal">
                        ...
                        <x-slot:content>
                            ...
                            {!! view_render_event('admin.settings.users.index.form.user_status.before') !!}

                            <!-- Status -->
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.users.index.create.user_status')
                                </x-admin::form.control-group.label>
                                ...
                                <label class="relative inline-flex cursor-pointer items-center">
                                    <input  
                                        ...
                                        id="user_status"
                                        class="peer sr-only"
                                        :checked="parseInt(user.user_status || 0)"
                                    >
                            ...
                            {!! view_render_event('admin.settings.users.index.form.user_status.after') !!}
                        </x-slot>
