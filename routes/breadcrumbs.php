...
Breadcrumbs::for('chat', function (BreadcrumbTrail $trail, $route) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.chat.index'), route('admin.chat.index'));
});
...
Breadcrumbs::for('projects', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.projects.index.title'), route('admin.projects.index'));
});
...
// Dashboard > Projects > View Project
Breadcrumbs::for('projects.view', function (BreadcrumbTrail $trail, $project) {
    $trail->parent('projects');
    $trail->push('#'.$project->id, route('admin.projects.view', $project->id));
});

// Dashboard > Projects > Edit Project
Breadcrumbs::for('projects.edit', function (BreadcrumbTrail $trail, $project) {
    $trail->parent('projects');
    $trail->push(trans('admin::app.projects.edit.title'), route('admin.projects.edit', $project->id));
});



// Project Categories
Breadcrumbs::for('projects.categories', function (BreadcrumbTrail $trail) {
    $trail->parent('projects');
    $trail->push(trans('admin::app.projects.categories.index.title'), route('admin.projects.categories.index'));
});

// Dashboard > Projects > Create Project
Breadcrumbs::for('projects.categories.create', function (BreadcrumbTrail $trail) {
    $trail->parent('projects.categories');
    $trail->push(trans('admin::app.projects.categories.create.title'), route('admin.projects.categories.create'));
});

// Dashboard > Projects > View Project
Breadcrumbs::for('projects.categories.view', function (BreadcrumbTrail $trail, $projectCategory) {
    $trail->parent('projects.categories');
    $trail->push('#'.$projectCategory->id, route('admin.projects.categories.view', $projectCategory->id));
});

// Dashboard > Projects > Edit Project
Breadcrumbs::for('projects.categories.edit', function (BreadcrumbTrail $trail, $projectCategory) {
    $trail->parent('projects.categories');
    $trail->push(trans('admin::app.projects.categories.edit.title'), route('admin.projects.categories.edit', $projectCategory->id));
});


// Project Tasks
Breadcrumbs::for('projects.tasks', function (BreadcrumbTrail $trail) {
    $trail->parent('projects');
    $trail->push(trans('admin::app.projects.tasks.index.title'), route('admin.projects.tasks.index'));
});

// Dashboard > Projects > Create Project
Breadcrumbs::for('projects.tasks.create', function (BreadcrumbTrail $trail) {
    $trail->parent('projects.tasks');
    $trail->push(trans('admin::app.projects.tasks.create.title'), route('admin.projects.tasks.create'));
});

// Dashboard > Projects > View Project
Breadcrumbs::for('projects.tasks.view', function (BreadcrumbTrail $trail, $projectTask) {
    $trail->parent('projects.tasks');
    $trail->push('#'.$projectTask->id, route('admin.projects.tasks.view', $projectTask->id));
});

// Dashboard > Projects > Edit Project
Breadcrumbs::for('projects.tasks.edit', function (BreadcrumbTrail $trail, $projectTask) {
    $trail->parent('projects.tasks');
    $trail->push(trans('admin::app.projects.tasks.edit.title'), route('admin.projects.tasks.edit', $projectTask->id));
});
